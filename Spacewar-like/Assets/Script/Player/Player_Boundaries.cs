...
public class Player_Boundaries : MonoBehaviour
{
    ...
    public void RePosition()
    {
        ...
        if(sideIndex == 1)
        {
            ...
            transform.position = center + new Vector3(transform.position.x, transform.position.y  ,pos.z *-1);
        ...
        {
            Vector3 pos = transform.position - center;
            transform.position = center + new Vector3(pos.x*-1,transform.position.y , transform.position.z);
